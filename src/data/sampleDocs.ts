...
export const sampleDocuments: KnowledgeDocument[] = [
  ...
  },
  {
    ...
    tags: ["제안서", "RFP", "영업", "ROI"],
    content:
      "제안서는 고객의 현재 문제, 도입 목표, 기대 효과, 일정, 리스크 관리, 가격 구조 순서로 작성한다. Enterprise GenAI 제안의 경우 PoC 범위는 4~6주로 제한하고, 성공 기준은 검색 정확도, 상담 처리 시간, 자동화 완료율, 사용자 만족도 중 3개 이상으로 정의한다. 무료 또는 오픈소스 기반 파일럿은 로컬 LLM, 브라우저 기반 검색, 오픈소스 벡터DB, 사내 SSO 연계 전 단계 모의 권한 정책으로 구성할 수 있다."
  },
  {
    id: "kpi-framework",

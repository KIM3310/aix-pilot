...
export type ArchitecturePersona = {
  id: string;
  role: string;
  pain: string;
...
export const architecturePersonas: ArchitecturePersona[] = [
  {
    id: "REV-PMO",
    role: "AI PMO",
...
export const adoptionMotions: AdoptionMotion[] = [
  {
    id: "MOTION-WEDGE",
    stage: "01 Wedge",

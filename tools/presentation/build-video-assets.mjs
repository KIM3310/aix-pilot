...
const scenes = [
  ...
  },
  {
    ...
    subtitle: "6주 파일럿 계획과\n자동 QA 루틴까지 준비했습니다",
    narration:
      "실제 파일럿 전환 계획은 6주입니다. 첫 주에는 반복 업무 하나를 고정하고, 둘째 주에는 문서 메타데이터를 정리합니다. 셋째와 넷째 주에는 RAG와 Agent를 골든 질문셋으로 검증하고, 다섯째 주에는 보안 리뷰를 진행합니다. 여섯째 주에는 품질, 회수 시간, 리스크를 하나의 Go No-Go 리포트로 제출합니다."
  },
  {
    id: "09",
    slide: "slide-09.png",

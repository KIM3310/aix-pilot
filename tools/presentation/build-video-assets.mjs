...
const scenes = [
  ...
  },
  {
    ...
    slide: "slide-07.png",
    title: "가치 준비도",
    subtitle: "범위는 기능 수보다\n회수 시간과 승인 근거에서 결정됩니다",
    narration:
      "AIX Pilot은 공개 가격표나 매출 추정치를 보여주지 않습니다. 대신 반복 업무 회수 시간, 승인 단계, 필요한 클라우드 리소스, 보안 게이트를 한 화면에서 정리합니다. 핵심은 먼저 돈 이야기를 하는 것이 아니라, 운영 리더와 보안 담당자가 계속 진행해도 되는 근거를 만드는 것입니다."
  },
  {
    id: "08",
    slide: "slide-08.png",
    ...
    subtitle: "6주 파일럿 계획과\n자동 QA 루틴까지 준비했습니다",
    narration:
      "실제 파일럿 전환 계획은 6주입니다. 첫 주에는 반복 업무 하나를 고정하고, 둘째 주에는 문서 메타데이터를 정리합니다. 셋째와 넷째 주에는 RAG와 Agent를 골든 질문셋으로 검증하고, 다섯째 주에는 보안 점검를 진행합니다. 여섯째 주에는 품질, 회수 시간, 리스크를 하나의 Go No-Go 리포트로 제출합니다."
  },
  {
    id: "09",
    slide: "slide-09.png",
    ...
    narration:
      "최종적으로 AIX Pilot은 RAG, Agent, 보안, 평가, KPI, 가치 준비도, 무료 운영 스택이 연결된 검증 가능한 서비스가 되었습니다. 이 프로젝트의 핵심은 생성형 AI 기능을 만든 것이 아니라, 기업이 실제로 도입을 승인할 수 있는 운영 모델을 제품화했다는 점입니다. 감사합니다."
  }
];

...
- **Lane:** Enterprise AI adoption and governance
- **Primary buyer:** AI, data, security, and platform teams validating governed GenAI rollout
- **First motion:** Readiness review, data-boundary mapping, then a scoped pilot with buyer-provided non-sensitive sample data

## Recommended Architecture

Cloudflare Pages for the console, Workers or container API for secure orchestration, managed Postgres for tenant and eval metadata, R2 for evidence exports, queue for eval and ingestion jobs.
...
- R2 object storage
- queue or scheduler
- OpenAI API key with spend limits
- Sentry/analytics
...
- tenant isolation before real customer data
- token and tool-call budget caps
- human approval for generated actions

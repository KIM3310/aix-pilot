# Service Growth Model - aix-pilot
...
| Field | Decision |
|---|---|
| Service type | Enterprise AI adoption and governance |
| Primary reader or buyer | AI, data, security, and platform teams validating governed GenAI rollout. |
| Wedge | Readiness review, data-boundary mapping, then a scoped pilot with buyer-provided non-sensitive sample data. |

# Revenue Architecture - aix-pilot
...
| Repo-specific launch path | Cloudflare Pages app, Workers Functions, D1/KV workspace state, R2 document packs, OpenRouter/Groq/Workers AI with customer-key override |

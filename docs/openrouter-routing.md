...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `google/gemini-3.5-flash` | Enterprise GenAI pilot copilot, KPI framing, and adoption workshop summaries. |
...
OPENROUTER_HTTP_REFERER=https://aix-pilot.pages.dev
OPENROUTER_APP_TITLE=aix-pilot
```

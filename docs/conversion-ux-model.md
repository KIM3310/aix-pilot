...
| First action | Inspect npm run qa passes, then move directly to the narrow demo or buyer-specific checklist. |
...
| Specificity | Use one role, one workflow, one outcome, and one proof artifact per landing path. |
| Commitment | End demos with a written pilot checklist that the buyer can circulate internally. |

## Design System Direction

- Use an enterprise SaaS pattern: problem, proof, controls, workflow, pilot CTA.
- Prefer compact dashboards, comparison tables, before/after evidence, and role-specific views.
- Keep the interface quiet and credible: no oversized hype sections, no fake logos, no unsupported traction.

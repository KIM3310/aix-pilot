...
- [Machine-readable architecture manifest](docs/architecture/blueprint.json) keeps the blueprint inspectable in CI.
...
- Value Readiness: 반복 업무 회수 시간, 규제 산업 고객센터 타깃, 승인자 지도, 운영 리소스, 검토자 심리/조직 문화별 도입 전략
...
src/
  ...
  data/
    businessModel.ts     # 서비스 패키지, 검토자 심리, 문화 도입, 검증 실험 데이터
